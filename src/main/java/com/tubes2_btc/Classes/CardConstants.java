...
public class CardConstants {
    ...
    public static Card createCard(int i) {
        switch (i) {
            case CARD_EMPTY_INDEX: return new Card(CARD_EMPTY, "");

            case CARD_HIU_INDEX: return new Animal(CARD_HIU, CARD_HIU_PATH, 0, 20, Animal.ANIMAL_KARNIVORA, CARD_SIRIP_HIU);
            case CARD_SAPI_INDEX: return new Animal(CARD_SAPI, CARD_SAPI_PATH, 0, 10, Animal.ANIMAL_HERBIVORA, CARD_SUSU);
            case CARD_DOMBA_INDEX: return new Animal(CARD_DOMBA, CARD_DOMBA_PATH, 0, 12, Animal.ANIMAL_HERBIVORA, CARD_DAGING_DOMBA);
            case CARD_KUDA_INDEX: return new Animal(CARD_KUDA, CARD_KUDA_PATH, 0, 14, Animal.ANIMAL_HERBIVORA, CARD_DAGING_KUDA);
            case CARD_AYAM_INDEX: return new Animal(CARD_AYAM, CARD_AYAM_PATH, 0, 5, Animal.ANIMAL_OMNIVORA, CARD_TELUR);
            case CARD_BERUANG_INDEX: return new Animal(CARD_BERUANG, CARD_BERUANG_PATH, 0, 25, Animal.ANIMAL_OMNIVORA, CARD_DAGING_BERUANG);

            case CARD_BIJI_LABU_INDEX: return new Plant(CARD_BIJI_LABU, CARD_BIJI_LABU_PATH, 0, 5, CARD_LABU);
            case CARD_BIJI_JAGUNG_INDEX: return new Plant(CARD_BIJI_JAGUNG, CARD_BIJI_JAGUNG_PATH, 0, 3, CARD_JAGUNG);
            case CARD_BIJI_STROBERI_INDEX: return new Plant(CARD_BIJI_STROBERI, CARD_BIJI_STROBERI_PATH, 0, 4, CARD_STROBERI);

            case CARD_SIRIP_HIU_INDEX: return new Product(CARD_SIRIP_HIU, CARD_SIRIP_HIU_PATH, 500, 12, Product.PRODUCT_CARNIVORE_FOOD);
            case CARD_SUSU_INDEX: return new Product(CARD_SUSU, CARD_SUSU_PATH, 100, 4, Product.PRODUCT_CARNIVORE_FOOD);
            case CARD_DAGING_DOMBA_INDEX: return new Product(CARD_DAGING_DOMBA, CARD_DAGING_DOMBA_PATH, 120, 6, Product.PRODUCT_CARNIVORE_FOOD);
            case CARD_DAGING_KUDA_INDEX: return new Product(CARD_DAGING_KUDA, CARD_DAGING_KUDA_PATH, 150, 8, Product.PRODUCT_CARNIVORE_FOOD);
            case CARD_TELUR_INDEX: return new Product(CARD_TELUR, CARD_TELUR_PATH, 50, 2, Product.PRODUCT_CARNIVORE_FOOD);
            case CARD_DAGING_BERUANG_INDEX: return new Product(CARD_DAGING_BERUANG, CARD_DAGING_BERUANG_PATH, 500, 12, Product.PRODUCT_CARNIVORE_FOOD);
            case CARD_JAGUNG_INDEX: return new Product(CARD_JAGUNG, CARD_JAGUNG_PATH, 150, 3, Product.PRODUCT_HERBIVORE_FOOD);
            case CARD_LABU_INDEX: return new Product(CARD_LABU, CARD_LABU_PATH, 500, 10, Product.PRODUCT_HERBIVORE_FOOD);
            case CARD_STROBERI_INDEX: return new Product(CARD_STROBERI, CARD_STROBERI_PATH, 350, 5, Product.PRODUCT_HERBIVORE_FOOD);

            case CARD_ACCELERATE_INDEX: return new Card(CARD_ACCELERATE, CARD_ACCELERATE_PATH);
            case CARD_DELAY_INDEX: return new Card(CARD_DELAY, CARD_DELAY_PATH);
            case CARD_INSTANT_HARVEST_INDEX: return new Card(CARD_INSTANT_HARVEST, CARD_INSTANT_HARVEST_PATH);
            case CARD_DESTROY_INDEX: return new Card(CARD_DESTROY, CARD_DESTROY_PATH);
            case CARD_PROTECT_INDEX: return new Card(CARD_PROTECT, CARD_PROTECT_PATH);
            case CARD_TRAP_INDEX: return new Card(CARD_TRAP, CARD_TRAP_PATH);

            default: return new Card(CARD_EMPTY, "");
        }
    }
}
